    ...
    <div class="relative h-screen overflow-hidden">
        ...
        <div class="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center">
            <div class="text-center text-white">
                ...
                <a href="#" class="bg-red-500 hover:bg-red-700 text-white font-bold py-3 px-6 rounded-full text-lg">Nos Conheça</a>
            </div>
        </div>
...
<section class="bg-gray py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <h2 class="text-3xl font-extrabold text-gray-900">Nos Conheça</h2>
            <p class="mt-4 text-lg text-gray-600">Sua jornada fitness começa aqui! Conheça nossa academia e tudo o que podemos oferecer para ajudar você a alcançar seus objetivos de saúde e bem-estar.</p>
        </div>
        <div class="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="p-6 bg-white shadow-lg rounded-lg">
                <h3 class="text-xl font-semibold text-gray-900">Nossos Valores</h3>
                <p class="mt-4 text-gray-600">Valorizamos a saúde, o bem-estar e a superação pessoal. Nossa missão é fornecer um ambiente acolhedor e motivador para todos os nossos membros.</p>
            </div>
            <div class="p-6 bg-white shadow-lg rounded-lg">
                <h3 class="text-xl font-semibold text-gray-900">Nossas Instalações</h3>
                <p class="mt-4 text-gray-600">Equipamentos de última geração, áreas de treino amplas e confortáveis, e uma equipe dedicada para auxiliar você em cada etapa do seu treino.</p>
            </div>
            <div class="p-6 bg-white shadow-lg rounded-lg">
...
<main>
        ...
        <div class="relative overflow-hidden bg-gray">
    <h3 class="text-xl font-semibold mt-8 mb-4 text-center font-serif">Atividades Registradas</h3>
    <div id="atividadesCarousel" class=" flex transition-transform duration-700 p-2 rounded-xl items-center justify-center">
        ...
        <?php endif; ?>
        <div class="absolute inset-y-0 left-0 flex items-center">
            <button id="prevAtiv" class="bg-white text-gray-800 p-2 rounded-full shadow-lg hover:bg-gray-200 m-1">&lt;</button>
        </div>
        <div class="absolute inset-y-0 right-0 flex items-center">
            <button id="nextAtiv" class="bg-white text-gray-800 p-2 rounded-full shadow-lg hover:bg-gray-200 m-1">&gt;</button>
        </div>
    </div>
